...
"almost-everything.md": {
	id: "almost-everything.md";
  slug: "almost-everything";
  body: string;
  collection: "book";
  data: any
} & { render(): Render[".md"] };
...
"distrust-that-particular-flavor.md": {
	id: "distrust-that-particular-flavor.md";
  slug: "distrust-that-particular-flavor";
  body: string;
  collection: "book";
  data: any
} & { render(): Render[".md"] };
...
"lincoln-in-the-bardo.md": {
	id: "lincoln-in-the-bardo.md";
...
"termination-shock.md": {
	id: "termination-shock.md";
